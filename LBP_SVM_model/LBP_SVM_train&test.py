...
train_data_x = []
train_data_y = []
if  os.path.exists(os.path.join(cur_dir, 'LBPFeature_data.txt')) \
    and os.path.exists(os.path.join(cur_dir, 'LBPFeature_label.txt')):
    ...
    sys.stdout.flush()
    train_data_x = np.loadtxt(os.path.join(cur_dir, 'LBPFeature_data.txt'), dtype='f')
    train_data_y = np.loadtxt(os.path.join(cur_dir, 'LBPFeature_label.txt'), dtype=int)
else:
    ...
    np.savetxt(os.path.join(cur_dir, 'LBPFeature_data.txt'), train_data_x, fmt='%f')
    np.savetxt(os.path.join(cur_dir, 'LBPFeature_label.txt'), train_data_y, fmt='%d')
